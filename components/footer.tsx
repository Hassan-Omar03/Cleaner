...
import { Facebook, Instagram, Music3, ArrowUp } from 'lucide-react'
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#195a88] text-white py-16 px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-white hover:text-yellow-400 hover:translate-x-2 transition-all duration-300 font-medium inline-block"
                >
                  → Home
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              <p className="text-white font-medium">📞 +971 0569407167 / +971 0522032532</p>
              <p className="text-white font-medium">📧 hodashineservices@gmail.com</p>
            </div>
              ...
              {[
                ...
                return (
                  <a
                    key={idx}
                    href={social.href}
                    className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center hover:bg-yellow-500 hover:text-[#195a88] transition-all duration-300 transform hover:scale-125 hover:-translate-y-1 shadow-lg"
                    title={social.label}
                    target="_blank"
                  >
                    <Icon size={22} />
