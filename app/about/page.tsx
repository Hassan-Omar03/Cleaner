    ...
    <main className="min-h-screen bg-white">
            ...
            {values.map((value, i) => {
              ...
              return (
                <div key={i} className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                  <Icon size={48} className="text-teal-800 mb-4" />
      ...
      <section className="py-20 px-6 md:px-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-teal-700 font-semibold mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-lg text-gray-700">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <Award className="text-teal-700 mt-1" size={26} />
                {item}
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              <PhoneCall size={48} className="text-teal-800 mb-4" />
            ...
            <div className="flex flex-col items-center text-center">
              <MapPin size={48} className="text-teal-800 mb-4" />
            ...
            <div className="flex flex-col items-center text-center">
              <UserCheck size={48} className="text-teal-800 mb-4" />
